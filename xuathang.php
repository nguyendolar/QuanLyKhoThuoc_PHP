                        ...
                        <div class="card-body">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <?php 
                                    ...
                                    FROM phieuxuatkho as a,thung as b, sanpham as c
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <select class="form-select" aria-label="Default select example" id="theloai" tabindex="8" name="thungsp" required>
                                                                    ...
                                                                    <?php
                                                                     $lsp = mysqli_query($connect, "SELECT a.*, b.ten FROM thung as a,sanpham as b WHERE a.sanpham_id = b.id AND a.soluongthung != 0 ORDER BY a.ngayhethan DESC");
